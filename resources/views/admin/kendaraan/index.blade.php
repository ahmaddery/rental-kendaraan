            ...
            <table class="table table-bordered table-hover" id="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td nowrap>
                            <a href="{{ route('admin.kendaraan.show', $kendaraan->id) }}" class="btn btn-info btn-sm">Lihat</a>
                            <a href="{{ route('admin.kendaraan.edit', $kendaraan->id) }}" class="btn btn-primary btn-sm">Edit</a>
